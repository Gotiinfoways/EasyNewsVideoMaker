...
import com.easynewsvideomaker.easynewsvideomaker.databinding.FragmentVideoExport9Binding
...
class VideoExport9Fragment : Fragment() {

    lateinit var exportBinding: FragmentVideoExport9Binding
...
//    var centerTextPostionY = 0f
    ...
    override fun onCreateView(
        ...
        exportBinding = FragmentVideoExport9Binding.inflate(layoutInflater, container, false)
...
//        }).start()
    ...
    private fun initView() {
        ...
        exportBinding.txtLay4.isSelected = true
        ...
        top2TextScroll = arguments?.getString("top2TextScrollPath")
        top2TextColor = arguments?.getString("top2TextColor")
        ...
        exportBinding.txtLay2.setText(top2TextScroll)
        exportBinding.txtLay3.setText(centerTextScroll)
        exportBinding.txtLay4.setText(bottomTextScroll)
...
//        var centerTextOnScreenY = centerTextPostionY
        ...
        var textInputeTop2 = top2TextScroll
        var textInputeTop2Color = top2TextColor
        ...
        val textInputeSize4 = calculateText4FontSize(requireContext(), tvInputPathVideo)

        val yTopPosition: Int = calculateYTopPosition(requireContext(), tvInputPathVideo)
        val yTop2Position: Int = calculateYTop2Position(requireContext(), tvInputPathVideo)
        ...
        val query = ffmpegQueryExtension.addFrame9VideoEditFun(
            tvInputPathVideo,
            tvInputPathImage,
            textInputeTop!!,
            yTopPosition,
...
//                exportBinding.txtOutputPath.text = logMessage.text
    ...
    private fun calculateText4FontSize(context: Context, videoPath: String): Int {
        // Calculate font size based on video dimensions or other factors.
        val videoHeight = getVideoHeight(videoPath)
        val videoWidth = getVideoWidth(videoPath)
    ...
    private fun calculateYTopPosition(
        ...
        return (0.02 * videoHeight).toInt()
    }

    private fun calculateYTop2Position(
        context: Context,
        videoPath: String
    ): Int {
        // Calculate the Y position based on video dimensions or other factors.

...
import com.easynewsvideomaker.easynewsvideomaker.databinding.FragmentVideoExport11Binding
...
class VideoExport11Fragment : Fragment() {

    lateinit var exportBinding: FragmentVideoExport11Binding
...
//    var centerTextPostionY = 0f
    ...
    override fun onCreateView(
        ...
        exportBinding = FragmentVideoExport11Binding.inflate(layoutInflater, container, false)
...
//        var centerTextOnScreenY = centerTextPostionY
        ...
        val query = ffmpegQueryExtension.addFrame11VideoEditFun(
            tvInputPathVideo,
            tvInputPathImage,
            textInputeTop!!,
            yTopPosition,

...
import com.easynewsvideomaker.easynewsvideomaker.news_video.video_export.VideoExport3Fragment
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                for (postSnapshot in snapshot.children) {
                    ...
                    Glide.with(requireContext()).load(channelLogo).placeholder(R.drawable.news_logo)
                        .into(videoFrame3Binding.imgNewsLoge)
                }
            }
...
//        videoFrame2Binding.vidView.setOnPreparedListener { mp -> setVolumeControl(mp) }
        ...
        videoFrame3Binding.vidView.scaleX = 1.4f
        videoFrame3Binding.vidView.scaleY = 1.4f

...
import com.easynewsvideomaker.easynewsvideomaker.databinding.FragmentVideoExport3Binding
...
class VideoExport3Fragment : Fragment() {
    lateinit var exportBinding: FragmentVideoExport3Binding
    ...
    override fun onCreateView(
        ...
        exportBinding = FragmentVideoExport3Binding.inflate(layoutInflater, container, false)
...
//            downloadVideo()
    ...
    private fun addVideoEditFun(fileName: String) {
        ...
        val query = ffmpegQueryExtension.addFrame2VideoEditFun(
            tvInputPathVideo,
            tvInputPathImage,
            textInputeCenter!!,
            yCenterPosition,

...
import com.easynewsvideomaker.easynewsvideomaker.news_video.video_export.VideoExport6Fragment
...
class VideoFrame6Fragment : Fragment() {
  lateinit var videoFrame6Binding: FragmentVideoFrame6Binding
    ...
    override fun onCreateView(
        ...
        initView()
        frameEdit()
        return videoFrame6Binding.root
    }


    private fun frameEdit() {
        //text scroll Horizontally
        videoFrame6Binding.txtLay1.isSelected = true
        ...
        videoFrame6Binding.txtCityName.setOnClickListener {
            var text = videoFrame6Binding.txtCityName.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame6Binding.txtCityName.text = dialogEditBinding.edtText.text.toString()
...
//        }
        ...
        videoFrame6Binding.txtLay1.setOnClickListener {
            var text = videoFrame6Binding.txtLay1.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame6Binding.txtLay1.text = dialogEditBinding.edtText.text.toString()
        ...
        videoFrame6Binding.txtLay2.setOnClickListener {
            var text = videoFrame6Binding.txtLay2.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame6Binding.txtLay2.text = dialogEditBinding.edtText.text.toString()
    ...
    private fun initView() {
        ...
        videoFrame6Binding.linCaptureVideo.setOnClickListener {
            val i = Intent(MediaStore.ACTION_VIDEO_CAPTURE)
            startActivityForResult(i, 1)
        }
        videoFrame6Binding.linImportVideo.setOnClickListener {
        ...
        mediaController.setAnchorView(videoFrame6Binding.vidView)
        // sets the media player to the videoView
        mediaController.setMediaPlayer(videoFrame6Binding.vidView)
        //volume set
//        videoFrame2Binding.vidView.setOnPreparedListener { mp -> setVolumeControl(mp) }

        videoFrame6Binding.vidView.scaleX = 1.4f
        videoFrame6Binding.vidView.scaleY = 1.4f

        // sets the media controller to the videoView
        videoFrame6Binding.vidView.setMediaController(mediaController);


        //Video Export
        videoFrame6Binding.cdExploreBtn.setOnClickListener {
            ...
            if (videoPath == null) {
                ...
                var centerTextScroll = videoFrame6Binding.txtLay1.text.toString()
                var bottomTextScroll = videoFrame6Binding.txtLay2.text.toString()
                // Get the text size of the TextView
                val centerTextSize = videoFrame6Binding.txtLay1.textSize.toInt()
                val bottomTextSize = videoFrame6Binding.txtLay2.textSize.toInt()

                var centerColorText = videoFrame6Binding.txtLay1.currentTextColor
                val centerTextColor = String.format("#%06X", 0xFFFFFF and centerColorText)


                var bottomColorText = videoFrame6Binding.txtLay2.currentTextColor
        ...
        if (requestCode == PICK_VIDEO_REQUEST && resultCode == Activity.RESULT_OK) {
            if (data != null) {
                ...
                if (selectedVideoUri != null) {
                    ...
                    videoFrame6Binding.vidView.setVideoURI(selectedVideoUri)
                    videoFrame6Binding.vidView.requestFocus()


                    // Start playing the video
                    videoFrame6Binding.vidView.visibility = View.VISIBLE
//                    videoFrame3Binding.linVideoZoom.visibility = View.VISIBLE
//                    videoFrame3Binding.linBtn.visibility = View.VISIBLE
                    videoFrame6Binding.imgView.visibility = View.INVISIBLE
                    videoFrame6Binding.vidView.start()
...
//                var selectedImageUri = getImagePathFromURI(uri!!)
                videoFrame6Binding.imgNewsLoge.setImageURI(uri)
            }
        })
...
//    }
    ...
    fun saveFrameLayoutAsImage() {
        ...
        var transparentBitmap = Bitmap.createBitmap(
            videoFrame6Binding.frameView.getWidth(),
            videoFrame6Binding.frameView.getHeight(),
        ...
        videoFrame6Binding.frameView.draw(canvas)

...
import com.easynewsvideomaker.easynewsvideomaker.databinding.FragmentVideoExport6Binding
...
class VideoExport6Fragment : Fragment() {

    lateinit var exportBinding: FragmentVideoExport6Binding
...
//    var centerTextPostionY = 0f
    ...
    override fun onCreateView(
        ...
        exportBinding = FragmentVideoExport6Binding.inflate(layoutInflater, container, false)
...
//        }).start()
    ...
    private fun initView() {
        ...
        exportBinding.txtLay1.setText(centerTextScroll)
        exportBinding.txtLay2.setText(bottomTextScroll)
...
//        var textInputeCenterSize = centerTextSize
        ...
        val query = ffmpegQueryExtension.addFrame6_and_7VideoEditFun(
            tvInputPathVideo,
            tvInputPathImage,
            textInputeCenter!!,
            yCenterPosition,

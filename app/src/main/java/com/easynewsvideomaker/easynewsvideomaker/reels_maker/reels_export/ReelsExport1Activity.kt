...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityReelsExport1Binding
...
class ReelsExport1Activity : AppCompatActivity() {

    lateinit var exportBinding: ActivityReelsExport1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exportBinding = ActivityReelsExport1Binding.inflate(layoutInflater)
...
//
        ...
        val query = ffmpegQueryExtension.addFrame1ReelsMakerFun(
            inputVideo,
            imageInput,
            textInput!!,
            textInputeColor!!,
...
//                exportBinding.txtOutputPath.text = logMessage.text
            ...
            override fun failed() {
                ...
                downloadProgressDialog.dismiss()
                Toast.makeText(this@ReelsExport1Activity, "Video Download Fail", Toast.LENGTH_SHORT)
                    .show()
            }
        })
    }

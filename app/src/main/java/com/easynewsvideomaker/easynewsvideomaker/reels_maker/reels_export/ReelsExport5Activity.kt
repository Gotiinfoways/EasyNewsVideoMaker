...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityReelsExport5Binding
...
class ReelsExport5Activity : AppCompatActivity() {

    lateinit var exportBinding: ActivityReelsExport5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exportBinding = ActivityReelsExport5Binding.inflate(layoutInflater)
...
//                exportBinding.txtOutputPath.text = logMessage.text
            ...
            override fun failed() {
                ...
                downloadProgressDialog.dismiss()
                Toast.makeText(this@ReelsExport5Activity, "Video Download Fail", Toast.LENGTH_SHORT)
                    .show()
            }
        })
    }

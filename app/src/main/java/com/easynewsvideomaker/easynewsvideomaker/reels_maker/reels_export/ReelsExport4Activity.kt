...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityReelsExport4Binding
...
class ReelsExport4Activity : AppCompatActivity() {

    lateinit var exportBinding: ActivityReelsExport4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exportBinding = ActivityReelsExport4Binding.inflate(layoutInflater)
...
//                exportBinding.txtOutputPath.text = logMessage.text
            ...
            override fun failed() {
                ...
                downloadProgressDialog.dismiss()
                Toast.makeText(this@ReelsExport4Activity, "Video Download Fail", Toast.LENGTH_SHORT)
                    .show()
            }
        })
    }

...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityReelsExport6Binding
...
class ReelsExport6Activity : AppCompatActivity() {

    lateinit var exportBinding: ActivityReelsExport6Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exportBinding = ActivityReelsExport6Binding.inflate(layoutInflater)
...
//        fontPath = intent?.getStringExtra("fontPath")!!
        ...
        exportBinding.vidExport.scaleX = 1.05f
        exportBinding.vidExport.scaleY = 1.05f
...
//                exportBinding.txtOutputPath.text = logMessage.text
            ...
            override fun failed() {
                ...
                downloadProgressDialog.dismiss()
                Toast.makeText(this@ReelsExport6Activity, "Video Download Fail", Toast.LENGTH_SHORT)
                    .show()
            }
        })
    }

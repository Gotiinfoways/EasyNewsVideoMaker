...
class Insta_4_Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityInsta4Binding.inflate(layoutInflater)
    ...
    private fun frameEdit() {
        ...
        binding.txtNews.setOnClickListener {
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNews.text = dialogEditBinding.edtText.text.toString()
                binding.txtNews.setTextColor(colorText)
        ...
        binding.txtUpdate.setOnClickListener {
            var text = binding.txtUpdate.text.toString()
            var textColor = binding.txtUpdate.currentTextColor
            editeDialog(text, textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtUpdate.text = dialogEditBinding.edtText.text.toString()
                binding.txtUpdate.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtLatestNews.setOnClickListener {
            var text = binding.txtLatestNews.text.toString()
            var textColor = binding.txtLatestNews.currentTextColor
            editeDialog(text, textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtLatestNews.text = dialogEditBinding.edtText.text.toString()
                binding.txtLatestNews.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
...
//        binding.vidView.setOnPreparedListener { mp -> setVolumeControl(mp) }
        ...
        binding.cdExportBtn.setOnClickListener {
            ...
            if (videoPath == null) {
                ...
                var i = Intent(this, ReelsExport4Activity::class.java)
    ...
    private fun addImageOnVideo(fileName: String) {
        ...
        CallBackOfQuery().callQuery(query, object : FFmpegCallBack {
            ...
            override fun success() {
                ...
                Toast.makeText(this@Insta_4_Activity, "Video Download Success", Toast.LENGTH_SHORT)
                    .show()
            }
            ...
            override fun cancel() {
                ...
                progressDialog.dismiss()
                Toast.makeText(this@Insta_4_Activity, "Video Download Cancel", Toast.LENGTH_SHORT)
                    .show()
            }
            ...
            override fun failed() {
                ...
                progressDialog.dismiss()
                Toast.makeText(this@Insta_4_Activity, "Video Download Fail", Toast.LENGTH_SHORT)
                    .show()
            }
        })
    }

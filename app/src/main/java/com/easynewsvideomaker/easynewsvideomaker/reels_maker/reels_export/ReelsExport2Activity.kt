...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityReelsExport2Binding
...
class ReelsExport2Activity : AppCompatActivity() {

    lateinit var exportBinding: ActivityReelsExport2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        exportBinding = ActivityReelsExport2Binding.inflate(layoutInflater)
...
//                exportBinding.txtOutputPath.text = logMessage.text
            ...
            override fun failed() {
                ...
                downloadProgressDialog.dismiss()
                Toast.makeText(this@ReelsExport2Activity, "Video Download Fail", Toast.LENGTH_SHORT)
                    .show()
            }
        })
    }

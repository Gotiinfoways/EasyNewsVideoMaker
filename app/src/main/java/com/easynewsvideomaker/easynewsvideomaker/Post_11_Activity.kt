...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost11Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_11_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost11Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost11Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick11.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture11.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn11.setOnClickListener {
        ...
        binding.txtBreakingNews11.setOnClickListener {
            var text = binding.txtBreakingNews11.text.toString()
            var textColor = binding.txtBreakingNews11.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews11.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews11.setTextColor(colorText)
        ...
        binding.txtheadingText11.setOnClickListener {
            var text = binding.txtheadingText11.text.toString()
            var textColor = binding.txtheadingText11.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtheadingText11.text = dialogEditBinding.edtText.text.toString()
                binding.txtheadingText11.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtAdditionalText11.setOnClickListener {
            var text = binding.txtAdditionalText11.text.toString()
            var textColor = binding.txtAdditionalText11.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText11.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText11.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel11.setOnClickListener {
            var text = binding.txtNewsChannel11.text.toString()
            var textColor = binding.txtNewsChannel11.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel11.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel11.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_11_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost11)
                }

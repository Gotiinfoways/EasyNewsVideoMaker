...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost14Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_14_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost14Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost14Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick14.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture14.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn14.setOnClickListener {
        ...
        binding.txtBreakingNews14.setOnClickListener {
            var text = binding.txtBreakingNews14.text.toString()
            var textColor = binding.txtBreakingNews14.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews14.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews14.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()

            }
        }
        binding.txtAdditionalText14.setOnClickListener {
            var text = binding.txtAdditionalText14.text.toString()
            var textColor = binding.txtAdditionalText14.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText14.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText14.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel14.setOnClickListener {
            var text = binding.txtNewsChannel14.text.toString()
            var textColor = binding.txtNewsChannel14.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel14.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel14.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_14_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost14)
                }

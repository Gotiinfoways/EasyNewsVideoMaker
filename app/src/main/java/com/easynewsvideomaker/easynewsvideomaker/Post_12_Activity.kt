...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost12Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_12_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost12Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost12Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick12.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture12.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn12.setOnClickListener {
        ...
        binding.txtBreakingNews12.setOnClickListener {
            var text = binding.txtBreakingNews12.text.toString()
            var textColor = binding.txtBreakingNews12.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews12.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews12.setTextColor(colorText)
        ...
        binding.txtAdditionalText12.setOnClickListener {
            var text = binding.txtAdditionalText12.text.toString()
            var textColor = binding.txtAdditionalText12.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText12.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText12.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel12.setOnClickListener {
            var text = binding.txtNewsChannel12.text.toString()
            var textColor = binding.txtNewsChannel12.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel12.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel12.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_12_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost12)
                }

...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost4Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_4_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost4Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick4.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture4.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn4.setOnClickListener {
        ...
        binding.txtBreakingNews4.setOnClickListener {
            var text = binding.txtBreakingNews4.text.toString()
            var textColor = binding.txtBreakingNews4.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews4.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews4.setTextColor(colorText)
        ...
        binding.txtheadingText4.setOnClickListener {
            var text = binding.txtheadingText4.text.toString()
            var textColor = binding.txtheadingText4.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtheadingText4.text = dialogEditBinding.edtText.text.toString()
                binding.txtheadingText4.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtAdditionalText4.setOnClickListener {
            var text = binding.txtAdditionalText4.text.toString()
            var textColor = binding.txtAdditionalText4.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText4.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText4.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel4.setOnClickListener {
            var text = binding.txtNewsChannel4.text.toString()
            var textColor = binding.txtNewsChannel4.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel4.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel4.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_4_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost1)
                }

...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost20Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_20_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost20Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost20Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick20.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture20.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn20.setOnClickListener {
        ...
        binding.txtBreakingNews20.setOnClickListener {
            var text = binding.txtBreakingNews20.text.toString()
            var textColor = binding.txtBreakingNews20.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews20.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews20.setTextColor(colorText)
        ...
        binding.txtAdditionalText20.setOnClickListener {
            var text = binding.txtAdditionalText20.text.toString()
            var textColor = binding.txtAdditionalText20.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText20.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText20.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel20.setOnClickListener {
            var text = binding.txtNewsChannel20.text.toString()
            var textColor = binding.txtNewsChannel20.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel20.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel20.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_20_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost20)
                }

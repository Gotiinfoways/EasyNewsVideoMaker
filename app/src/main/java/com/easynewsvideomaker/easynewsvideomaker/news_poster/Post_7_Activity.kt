...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost7Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_7_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost7Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost7Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick7.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture7.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn7.setOnClickListener {
        ...
        binding.txtBreakingNews7.setOnClickListener {
            var text = binding.txtBreakingNews7.text.toString()
            var textColor = binding.txtBreakingNews7.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews7.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews7.setTextColor(colorText)
        ...
        binding.txtheadingText7.setOnClickListener {
            var text = binding.txtheadingText7.text.toString()
            var textColor = binding.txtheadingText7.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtheadingText7.text = dialogEditBinding.edtText.text.toString()
                binding.txtheadingText7.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtAdditionalText7.setOnClickListener {
            var text = binding.txtAdditionalText7.text.toString()
            var textColor = binding.txtAdditionalText7.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText7.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText7.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel7.setOnClickListener {
            var text = binding.txtNewsChannel7.text.toString()
            var textColor = binding.txtNewsChannel7.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel7.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel7.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_7_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost7)
                }

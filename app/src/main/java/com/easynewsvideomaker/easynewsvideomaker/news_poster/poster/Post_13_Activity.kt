...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost13Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_13_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost13Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost13Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick13.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture13.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn13.setOnClickListener {
        ...
        binding.txtBreakingNews13.setOnClickListener {
            var text = binding.txtBreakingNews13.text.toString()
            var textColor = binding.txtBreakingNews13.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews13.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews13.setTextColor(colorText)
        ...
        binding.txtAdditionalText13.setOnClickListener {
            var text = binding.txtAdditionalText13.text.toString()
            var textColor = binding.txtAdditionalText13.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText13.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText13.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel13.setOnClickListener {
            var text = binding.txtNewsChannel13.text.toString()
            var textColor = binding.txtNewsChannel13.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel13.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel13.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_13_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost13)
                }

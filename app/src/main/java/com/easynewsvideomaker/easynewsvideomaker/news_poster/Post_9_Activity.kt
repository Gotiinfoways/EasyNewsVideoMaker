...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost9Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_9_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost9Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost9Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick9.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture9.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn9.setOnClickListener {
        ...
        binding.txtBreakingNews9.setOnClickListener {
            var text = binding.txtBreakingNews9.text.toString()
            var textColor = binding.txtBreakingNews9.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews9.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews9.setTextColor(colorText)
        ...
        binding.txtheadingText9.setOnClickListener {
            var text = binding.txtheadingText9.text.toString()
            var textColor = binding.txtheadingText9.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtheadingText9.text = dialogEditBinding.edtText.text.toString()
                binding.txtheadingText9.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtAdditionalText9.setOnClickListener {
            var text = binding.txtAdditionalText9.text.toString()
            var textColor = binding.txtAdditionalText9.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText9.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText9.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel9.setOnClickListener {
            var text = binding.txtNewsChannel9.text.toString()
            var textColor = binding.txtNewsChannel9.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel9.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel9.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_9_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost9)
                }

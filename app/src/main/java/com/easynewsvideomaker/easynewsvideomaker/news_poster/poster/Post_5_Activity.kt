...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost5Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_5_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost5Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick5.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture5.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn5.setOnClickListener {
        ...
        binding.txtBreakingNews5.setOnClickListener {
            var text = binding.txtBreakingNews5.text.toString()
            var textColor = binding.txtBreakingNews5.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews5.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews5.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
            }
        }

        binding.txtheadingText5.setOnClickListener {
            var text = binding.txtheadingText5.text.toString()
            var textColor = binding.txtheadingText5.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtheadingText5.text = dialogEditBinding.edtText.text.toString()
                binding.txtheadingText5.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtAdditionalText5.setOnClickListener {
            var text = binding.txtAdditionalText5.text.toString()
            var textColor = binding.txtAdditionalText5.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText5.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText5.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel5.setOnClickListener {
            var text = binding.txtNewsChannel5.text.toString()
            var textColor = binding.txtNewsChannel5.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel5.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel5.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_5_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost5)
                }

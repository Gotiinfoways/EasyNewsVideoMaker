...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost17Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_17_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost17Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost17Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick17.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture17.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn17.setOnClickListener {
        ...
        binding.txtBreakingNews17.setOnClickListener {
            var text = binding.txtBreakingNews17.text.toString()
            var textColor = binding.txtBreakingNews17.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews17.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews17.setTextColor(colorText)
        ...
        binding.txtheadingText17.setOnClickListener {
            var text = binding.txtheadingText17.text.toString()
            var textColor = binding.txtheadingText17.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtheadingText17.text = dialogEditBinding.edtText.text.toString()
                binding.txtheadingText17.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtAdditionalText17.setOnClickListener {
            var text = binding.txtAdditionalText17.text.toString()
            var textColor = binding.txtAdditionalText17.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText17.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText17.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel17.setOnClickListener {
            var text = binding.txtNewsChannel17.text.toString()
            var textColor = binding.txtNewsChannel17.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel17.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel17.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_17_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost17)
                }

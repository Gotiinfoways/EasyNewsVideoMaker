...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost18Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_18_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost18Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost18Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick18.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture18.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn18.setOnClickListener {
        ...
        binding.txtBreakingNews18.setOnClickListener {
            var text = binding.txtBreakingNews18.text.toString()
            var textColor = binding.txtBreakingNews18.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews18.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews18.setTextColor(colorText)
        ...
        binding.txtheadingText18.setOnClickListener {
            var text = binding.txtheadingText18.text.toString()
            var textColor = binding.txtheadingText18.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtheadingText18.text = dialogEditBinding.edtText.text.toString()
                binding.txtheadingText18.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtAdditionalText18.setOnClickListener {
            var text = binding.txtAdditionalText18.text.toString()
            var textColor = binding.txtAdditionalText18.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText18.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText18.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel18.setOnClickListener {
            var text = binding.txtNewsChannel18.text.toString()
            var textColor = binding.txtNewsChannel18.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel18.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel18.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_18_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost18)
                }

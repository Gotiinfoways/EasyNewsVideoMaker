...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost15Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_15_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost15Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost15Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick15.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture15.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn15.setOnClickListener {
        ...
        binding.txtBreakingNews15.setOnClickListener {
            var text = binding.txtBreakingNews15.text.toString()
            var textColor = binding.txtBreakingNews15.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews15.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews15.setTextColor(colorText)
        ...
        binding.txtAdditionalText15.setOnClickListener {
            var text = binding.txtAdditionalText15.text.toString()
            var textColor = binding.txtAdditionalText15.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText15.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText15.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtNewsChannel15.setOnClickListener {
            var text = binding.txtNewsChannel15.text.toString()
            var textColor = binding.txtNewsChannel15.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel15.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel15.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_15_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost15)
                }

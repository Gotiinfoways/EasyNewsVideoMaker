...
import com.easynewsvideomaker.easynewsvideomaker.databinding.ActivityPost8Binding
import com.easynewsvideomaker.easynewsvideomaker.databinding.DialogEditBinding
import yuku.ambilwarna.AmbilWarnaDialog

class Post_8_Activity : AppCompatActivity() {
    lateinit var binding: ActivityPost8Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPost8Binding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.imgpick8.setOnClickListener {
            val Gallery = Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
            Gallery_Launcher.launch(Gallery)
        }

        binding.imgcapture8.setOnClickListener {
            val intent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
            camera_Launcher.launch(intent)
        }

        binding.cdExploreBtn8.setOnClickListener {
        ...
        binding.txtBreakingNews8.setOnClickListener {
            var text = binding.txtBreakingNews8.text.toString()
            var textColor = binding.txtBreakingNews8.currentTextColor
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtBreakingNews8.text = dialogEditBinding.edtText.text.toString()
                binding.txtBreakingNews8.setTextColor(colorText)
        ...
        binding.txtheadingText8.setOnClickListener {
            var text = binding.txtheadingText8.text.toString()
            var textColor = binding.txtheadingText8.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtheadingText8.text = dialogEditBinding.edtText.text.toString()
                binding.txtheadingText8.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        binding.txtAdditionalText8.setOnClickListener {
            var text = binding.txtAdditionalText8.text.toString()
            var textColor = binding.txtAdditionalText8.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtAdditionalText8.text = dialogEditBinding.edtText.text.toString()
                binding.txtAdditionalText8.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()

            }
        }
        binding.txtNewsChannel8.setOnClickListener {
            var text = binding.txtNewsChannel8.text.toString()
            var textColor = binding.txtNewsChannel8.currentTextColor
            editeDialog(text,textColor)
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                binding.txtNewsChannel8.text = dialogEditBinding.edtText.text.toString()
                binding.txtNewsChannel8.setTextColor(colorText)
                Toast.makeText(this, "Your data is Change", Toast.LENGTH_SHORT).show()
                editeDialog.dismiss()
        ...
        object : ActivityResultCallback<ActivityResult?> {
            override fun onActivityResult(result: ActivityResult?) {
                if (result!!.resultCode == RESULT_OK) {
                    ...
                    Glide.with(this@Post_8_Activity)
                        .load(b)
                        .transform(CenterCrop())
                        .into(binding.imgpost8)
                }

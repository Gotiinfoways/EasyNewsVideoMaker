...
import com.easynewsvideomaker.easynewsvideomaker.databinding.FragmentVideoFrame5Binding
import com.easynewsvideomaker.easynewsvideomaker.fragment.video_export.VideoExport4_and_5Fragment
import java.io.File
import java.io.FileOutputStream
import java.io.IOException

class VideoFrame5Fragment : Fragment() {

lateinit var videoFrame5Binding: FragmentVideoFrame5Binding
    ...
    override fun onCreateView(
        ...
        videoFrame5Binding= FragmentVideoFrame5Binding.inflate(layoutInflater,container,false)
        // Inflate the layout for this fragment

        initView()
        frameEdit()
        return videoFrame5Binding.root
    }
    ...
    private fun frameEdit() {
        ...
        //set image
        videoFrame5Binding.imgNewsLoge.setOnClickListener {
        ...
        videoFrame5Binding.txtCityName.setOnClickListener {
            var text = videoFrame5Binding.txtCityName.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame5Binding.txtCityName.text = dialogEditBinding.edtText.text.toString()
...
//        }
        ...
        videoFrame5Binding.txtLay1.setOnClickListener {
            var text = videoFrame5Binding.txtLay1.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame5Binding.txtLay1.text = dialogEditBinding.edtText.text.toString()
        ...
        videoFrame5Binding.txtLay2.setOnClickListener {
            var text = videoFrame5Binding.txtLay2.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame5Binding.txtLay2.text = dialogEditBinding.edtText.text.toString()
    ...
    private fun initView() {
        ...
        videoFrame5Binding.linCaptureVideo.setOnClickListener {
            val i = Intent(MediaStore.ACTION_VIDEO_CAPTURE)
            startActivityForResult(i, 1)
        }
        videoFrame5Binding.linImportVideo.setOnClickListener {
        ...
        mediaController.setAnchorView(videoFrame5Binding.vidView)
        // sets the media player to the videoView
        mediaController.setMediaPlayer(videoFrame5Binding.vidView)
        //volume set
//        videoFrame2Binding.vidView.setOnPreparedListener { mp -> setVolumeControl(mp) }
        // sets the media controller to the videoView
        videoFrame5Binding.vidView.setMediaController(mediaController);
        videoFrame5Binding.vidView.scaleX = 1.4f
        videoFrame5Binding.vidView.scaleY = 1.4f


        //Video Export
        videoFrame5Binding.cdExploreBtn.setOnClickListener {
        ...
        if (requestCode == PICK_VIDEO_REQUEST && resultCode == Activity.RESULT_OK) {
            if (data != null) {
                ...
                if (selectedVideoUri != null) {
                    ...
                    videoFrame5Binding.vidView.setVideoURI(selectedVideoUri)
                    videoFrame5Binding.vidView.requestFocus()


                    // Start playing the video
                    videoFrame5Binding.vidView.visibility = View.VISIBLE
//                    videoFrame3Binding.linVideoZoom.visibility = View.VISIBLE
//                    videoFrame3Binding.linBtn.visibility = View.VISIBLE
                    videoFrame5Binding.imgView.visibility = View.INVISIBLE
                    videoFrame5Binding.vidView.start()
...
//                var selectedImageUri = getImagePathFromURI(uri!!)
                videoFrame5Binding.imgNewsLoge.setImageURI(uri)
            }
        })
...
//    }
    ...
    fun saveFrameLayoutAsImage() {
        ...
        var transparentBitmap = Bitmap.createBitmap(
            videoFrame5Binding.frameView.getWidth(),
            videoFrame5Binding.frameView.getHeight(),
        ...
        videoFrame5Binding.frameView.draw(canvas)

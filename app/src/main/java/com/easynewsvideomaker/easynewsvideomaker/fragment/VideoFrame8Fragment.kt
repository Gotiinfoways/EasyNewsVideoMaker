...
//        videoFrame2Binding.vidView.setOnPreparedListener { mp -> setVolumeControl(mp) }
        ...
        videoFrame8Binding.cdExploreBtn.setOnClickListener {
            ...
            if (videoPath == null) {
                ...
                var centerTextScroll = videoFrame8Binding.txtLay1.text.toString()
                var bottomTextScroll = videoFrame8Binding.txtLay2.text.toString()
                ...
                var centerColorText = videoFrame8Binding.txtLay1.currentTextColor
                val centerTextColor = String.format("#%06X", 0xFFFFFF and centerColorText)


                var bottomColorText = videoFrame8Binding.txtLay2.currentTextColor

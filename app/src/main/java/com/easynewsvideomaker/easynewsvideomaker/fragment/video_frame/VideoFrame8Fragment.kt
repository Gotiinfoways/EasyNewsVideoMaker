...
import com.easynewsvideomaker.easynewsvideomaker.databinding.FragmentVideoFrame8Binding
import com.easynewsvideomaker.easynewsvideomaker.fragment.video_export.VideoExport8Fragment
import java.io.File
import java.io.FileOutputStream
import java.io.IOException


class VideoFrame8Fragment : Fragment() {
lateinit var videoFrame8Binding: FragmentVideoFrame8Binding
    ...
    override fun onCreateView(
        ...
        videoFrame8Binding=FragmentVideoFrame8Binding.inflate(layoutInflater,container,false)
        // Inflate the layout for this fragment

        initView()
        frameEdit()
        return videoFrame8Binding.root
    }


    private fun frameEdit() {
        //text scroll Horizontally
        videoFrame8Binding.txtLay1.isSelected = true
        videoFrame8Binding.txtLay2.isSelected = true
        videoFrame8Binding.txtLay3.isSelected = true


        //set image
        videoFrame8Binding.imgNewsLoge.setOnClickListener {
        ...
        videoFrame8Binding.txtCityName.setOnClickListener {
            var text = videoFrame8Binding.txtCityName.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame8Binding.txtCityName.text = dialogEditBinding.edtText.text.toString()
...
//
        ...
        videoFrame8Binding.txtLay1.setOnClickListener {
            var text = videoFrame8Binding.txtLay1.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame8Binding.txtLay1.text = dialogEditBinding.edtText.text.toString()
        ...
        videoFrame8Binding.txtLay2.setOnClickListener {
            var text = videoFrame8Binding.txtLay2.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame8Binding.txtLay2.text = dialogEditBinding.edtText.text.toString()
        ...
        videoFrame8Binding.txtLay3.setOnClickListener {
            var text = videoFrame8Binding.txtLay3.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame8Binding.txtLay3.text = dialogEditBinding.edtText.text.toString()
    ...
    private fun initView() {
        ...
        videoFrame8Binding.linCaptureVideo.setOnClickListener {
            val i = Intent(MediaStore.ACTION_VIDEO_CAPTURE)
            startActivityForResult(i, 1)
        }
        videoFrame8Binding.linImportVideo.setOnClickListener {
        ...
        mediaController.setAnchorView(videoFrame8Binding.vidView)
        // sets the media player to the videoView
        mediaController.setMediaPlayer(videoFrame8Binding.vidView)
        //volume set
//        videoFrame2Binding.vidView.setOnPreparedListener { mp -> setVolumeControl(mp) }
        // sets the media controller to the videoView
        videoFrame8Binding.vidView.setMediaController(mediaController);

        videoFrame8Binding.vidView.scaleX = 1.4f
        videoFrame8Binding.vidView.scaleY = 1.4f

        //Video Export
        videoFrame8Binding.cdExploreBtn.setOnClickListener {
            ...
            if (videoPath == null) {
                ...
                var topTextScroll = videoFrame8Binding.txtLay1.text.toString()
                var centerTextScroll = videoFrame8Binding.txtLay2.text.toString()
                var bottomTextScroll = videoFrame8Binding.txtLay3.text.toString()
...
//                val bottomTextSize = videoFrame8Binding.txtLay2.textSize.toInt()
                ...
                var topColorText = videoFrame8Binding.txtLay1.currentTextColor
                val topTextColor = String.format("#%06X", 0xFFFFFF and topColorText)

                var centerColorText = videoFrame8Binding.txtLay2.currentTextColor
                val centerTextColor = String.format("#%06X", 0xFFFFFF and centerColorText)

                var bottomColorText = videoFrame8Binding.txtLay3.currentTextColor
                ...
                val fragment = VideoExport8Fragment()
                val bundle = Bundle()
        ...
        if (requestCode == PICK_VIDEO_REQUEST && resultCode == Activity.RESULT_OK) {
            if (data != null) {
                ...
                if (selectedVideoUri != null) {
                    ...
                    videoFrame8Binding.vidView.setVideoURI(selectedVideoUri)
                    videoFrame8Binding.vidView.requestFocus()


                    // Start playing the video
                    videoFrame8Binding.vidView.visibility = View.VISIBLE
//                    videoFrame3Binding.linVideoZoom.visibility = View.VISIBLE
//                    videoFrame3Binding.linBtn.visibility = View.VISIBLE
                    videoFrame8Binding.imgView.visibility = View.INVISIBLE
                    videoFrame8Binding.vidView.start()
...
//                var selectedImageUri = getImagePathFromURI(uri!!)
                videoFrame8Binding.imgNewsLoge.setImageURI(uri)
            }
        })
...
//    }
    ...
    fun saveFrameLayoutAsImage() {
        ...
        var transparentBitmap = Bitmap.createBitmap(
            videoFrame8Binding.frameView.getWidth(),
            videoFrame8Binding.frameView.getHeight(),
        ...
        videoFrame8Binding.frameView.draw(canvas)

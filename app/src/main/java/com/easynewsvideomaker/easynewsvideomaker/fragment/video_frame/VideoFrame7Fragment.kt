...
import com.easynewsvideomaker.easynewsvideomaker.databinding.FragmentVideoFrame7Binding
import com.easynewsvideomaker.easynewsvideomaker.fragment.video_export.VideoExport7Fragment
import java.io.File
import java.io.FileOutputStream
import java.io.IOException


class VideoFrame7Fragment : Fragment() {
    lateinit var videoFrame7Binding: FragmentVideoFrame7Binding
    ...
    override fun onCreateView(
        ...
        videoFrame7Binding = FragmentVideoFrame7Binding.inflate(layoutInflater, container, false)
        // Inflate the layout for this fragment


        initView()
        frameEdit()
        return videoFrame7Binding.root
    }


    private fun frameEdit() {
        //text scroll Horizontally
        videoFrame7Binding.txtLay1.isSelected = true
        videoFrame7Binding.txtLay2.isSelected = true


        //set image
        videoFrame7Binding.imgNewsLoge.setOnClickListener {
        ...
        videoFrame7Binding.txtCityName.setOnClickListener {
            var text = videoFrame7Binding.txtCityName.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame7Binding.txtCityName.text = dialogEditBinding.edtText.text.toString()
...
//        }
        ...
        videoFrame7Binding.txtLay1.setOnClickListener {
            var text = videoFrame7Binding.txtLay1.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame7Binding.txtLay1.text = dialogEditBinding.edtText.text.toString()
        ...
        videoFrame7Binding.txtLay2.setOnClickListener {
            var text = videoFrame7Binding.txtLay2.text.toString()
            ...
            dialogEditBinding.btnSubmit.setOnClickListener {
                ...
                videoFrame7Binding.txtLay2.text = dialogEditBinding.edtText.text.toString()
    ...
    private fun initView() {
        ...
        videoFrame7Binding.linCaptureVideo.setOnClickListener {
            val i = Intent(MediaStore.ACTION_VIDEO_CAPTURE)
            startActivityForResult(i, 1)
        }
        videoFrame7Binding.linImportVideo.setOnClickListener {
        ...
        mediaController.setAnchorView(videoFrame7Binding.vidView)
        // sets the media player to the videoView
        mediaController.setMediaPlayer(videoFrame7Binding.vidView)
        //volume set
//        videoFrame2Binding.vidView.setOnPreparedListener { mp -> setVolumeControl(mp) }
        // sets the media controller to the videoView
        videoFrame7Binding.vidView.setMediaController(mediaController);

        videoFrame7Binding.vidView.scaleX = 1.4f
        videoFrame7Binding.vidView.scaleY = 1.4f

        //Video Export
        videoFrame7Binding.cdExploreBtn.setOnClickListener {
            ...
            if (videoPath == null) {
                ...
                var centerTextScroll = videoFrame7Binding.txtLay1.text.toString()
                var bottomTextScroll = videoFrame7Binding.txtLay2.text.toString()
                // Get the text size of the TextView
                val centerTextSize = videoFrame7Binding.txtLay1.textSize.toInt()
                val bottomTextSize = videoFrame7Binding.txtLay2.textSize.toInt()

                var centerColorText = videoFrame7Binding.txtLay1.currentTextColor
                val centerTextColor = String.format("#%06X", 0xFFFFFF and centerColorText)


                var bottomColorText = videoFrame7Binding.txtLay2.currentTextColor
        ...
        if (requestCode == PICK_VIDEO_REQUEST && resultCode == Activity.RESULT_OK) {
            if (data != null) {
                ...
                if (selectedVideoUri != null) {
                    ...
                    videoFrame7Binding.vidView.setVideoURI(selectedVideoUri)
                    videoFrame7Binding.vidView.requestFocus()


                    // Start playing the video
                    videoFrame7Binding.vidView.visibility = View.VISIBLE
//                    videoFrame3Binding.linVideoZoom.visibility = View.VISIBLE
//                    videoFrame3Binding.linBtn.visibility = View.VISIBLE
                    videoFrame7Binding.imgView.visibility = View.INVISIBLE
                    videoFrame7Binding.vidView.start()
...
//                var selectedImageUri = getImagePathFromURI(uri!!)
                videoFrame7Binding.imgNewsLoge.setImageURI(uri)
            }
        })
...
//    }
    ...
    fun saveFrameLayoutAsImage() {
        ...
        var transparentBitmap = Bitmap.createBitmap(
            videoFrame7Binding.frameView.getWidth(),
            videoFrame7Binding.frameView.getHeight(),
        ...
        videoFrame7Binding.frameView.draw(canvas)
